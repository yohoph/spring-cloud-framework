 ...
 */
public class JmswSpringMvcContract extends Contract.BaseContract
    ...
    protected boolean processAnnotationsOnParameter(MethodMetadata data,
        ...
        AnnotatedParameterProcessor.AnnotatedParameterContext context = new JmswSpringMvcContract.SimpleAnnotatedParameterContext(
                data, paramIndex);
