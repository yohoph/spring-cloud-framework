package com.jmsw.framework.core.lock;
...
public class DistributedLockManager {
     ...
     * @return 已经加锁的ids
     */
    public String lock(String prefix, String ids) throws Exception {
     ...
     * @return 已经加锁的ids
     */
    public String lock(String prefix, String ids, long timeout) throws Exception {
     ...
     * @return 已经加锁的ids
     */
    public String lock(String prefix, String ids, long timeout, int expiredTime) throws Exception {
     ...
     * @param expire  失效时间
     */
    private void lockByKey(String key, long timeout, int expire) throws Exception {
        try {
